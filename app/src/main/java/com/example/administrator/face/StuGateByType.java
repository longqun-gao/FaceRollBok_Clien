...
public class StuGateByType extends AppCompatActivity implements View.OnClickListener {

    private ImageView mSelStugateBack;

    private ListView mGateListview;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_stu_gate_by_type);
        initView();
        urlpath = "GateByTypeServlet?gtype=0";
        getdata(urlpath);
    }

    private void initView() {
        mSelStugateBack = (ImageView) findViewById(R.id.sel_stugate_back);
        mGateListview = (ListView) findViewById(R.id.gate_listview);
        mSelStugateBack.setOnClickListener(this);
    }

    @Override
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.sel_stugate_back:
                finish();
                break;
        }
    }
    ...
    private Handler handler = new Handler(){
        ...
        public void handleMessage(Message msg) {
            ...
            if(msg.what == 0x123){
                ...
                mGateListview.setAdapter(myadapter);
            }
        }
    };
